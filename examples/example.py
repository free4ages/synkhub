...
async def run_example_sync():
    ...
    config_dict = {
        'name': 'sync_users_postgres_to_postgres',
        ...
        'column_map': [
            {'name': 'user_id', 'src': 'u.id', 'dest': 'user_id', 'unique_column': True, 'order_column': True, 'data_type':'int', 'direction': 'asc'},
        ...
        'strategies': [
            ...
            },
            {
                ...
                'type': 'hash',
                'column': 'created_at',
                'sub_partition_step': 60*60*24,
                'interval_reduction_factor': 3,
                'page_size': 1000
            },
        ],
        'enrichment': {
